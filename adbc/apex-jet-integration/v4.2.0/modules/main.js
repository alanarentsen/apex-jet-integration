...
require(['ojs/ojcore', 'knockout', 'jquery', 'ojs/ojknockout', 'ojs/ojmodule', 'css!./oraclejet/4.2.0/css/libs/oj/v4.2.0/alta/oj-alta-notag-min.css'],
  function(oj, ko, $)
  {
    oj.ModuleBinding.defaults.viewPath = 'text!../adbc/apex-jet-integration/v4.2.0/modules/views/';
    oj.ModuleBinding.defaults.modelPath = '../adbc/apex-jet-integration/v4.2.0/modules/viewModels/';
