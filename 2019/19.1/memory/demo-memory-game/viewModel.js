define(['knockout', 'ojs/ojknockout'],
  function (ko) {
    function model (context) {
      ...
      self.cards = ko.observable(createCards(context.properties.cards));
      ...
      function checkMatch(event) {
        ...
        if (!firstValue) {
          ...
          self.gameMsg("Pair matches. " + context.properties.attempts + " attempts made.");
          firstValue = null;
          matches++;
        } else {
          firstValue = null;
          var oldCard = firstCard;
          self.gameMsg("Pair not a match. Resetting. " + context.properties.attempts + " attempts made.");
        ...
        if (pairs === matches) {
          ...
          self.gameMsg("All pairs matched. You've won. " + context.properties.attempts + " attempts made.");
        }
      };
